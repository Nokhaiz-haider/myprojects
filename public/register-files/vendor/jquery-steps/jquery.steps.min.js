...
! function(a, b) {
    ...
    function J(b, c, d) {
        var e = '<{0} class="{1}">{2}</{0}>',
            ...
            h = a(e.format(c.contentContainerTag, "content col-md-9 " + c.clearFixCssClass, b.html())),
            i = a(e.format(c.stepsContainerTag, "steps col-md-3 " + c.clearFixCssClass, '<ul role="tablist"></ul>')),
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions col-md-9 {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
